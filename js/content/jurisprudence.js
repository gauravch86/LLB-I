    ...
    topics: [
      {
        ...
        <p><strong>Definition evolution (do not skip):</strong> CCS still sets “trace the evolution of the definition of jurisprudence.” The <strong>left-rail</strong> on this card is the <em>whole Sem-1 cast in year order</em> (Ulpian to Hart), each node a card with a school chip. Gold <strong>B-A-H-G-S-P</strong> is a compact definitions inset — and a filter — not the only timeline. Footer kernels: <strong>A→K→H</strong> (analytical) and <strong>I→D→P</strong> (sociological). Dedicated card + PYQ: <button type="button" class="text-link" data-nav="k1001" data-topic="j-def-evolution">Definitions — evolution of jurisprudence</button>.</p>`,
        analogy: {
      ...
      },
      {
        ...
        summary: "The 20-marker is a changelog. Primary rail = full Sem-1 cast in year order (Ulpian to Hart). Gold B-A-H-G-S-P = compact definitions inset/filter. Footer: A→K→H analytical; I→D→P sociological.",
        ...
        <p><strong>Primary artefact = the holistic left-rail</strong> (year · who · landmark · said · challenged · school tag). Walk it in year order: Ulpian’s <em>jurisprudentia</em> / <em>suum cuique</em>; Aquinas (classical NL); Bentham; Austin 1832 (command + sovereign + sanction); Savigny (Volksgeist); Maine (status → contract); Marx (base–superstructure); Ihering (Zweck / Interessenjurisprudenz); Holland; Salmond; Stammler (just law); Gray; Kohler (cultural NL revival); Duguit (social solidarity); Pound (social engineering); C.K. Allen (<em>Law in the Making</em>); American Realists (law in action); Kelsen (<em>Grundnorm</em>); Hart (primary/secondary rules, rule of recognition).</p>
        ...
        <p>Redraw the left-rail from memory (year · who · landmark · said · pushed back · school). Then open Paranjape chapter 1 for the longer extracts — this card does not copy that book.</p>`,
        analogy: {
