    ...
    topics: [
      {
        ...
        <p><strong>Definition evolution (do not skip):</strong> CCS still sets “trace the evolution of the definition of jurisprudence.” The <strong>left-rail</strong> on this card is the <em>whole Sem-1 cast in year order</em> (Ulpian to Hart), each node a card with a school chip and a country (Where). Gold <strong>B-A-H-G-S-P</strong> is a compact definitions inset — and a filter — not the only timeline. Footer kernels: <strong>A→K→H</strong> (analytical) and <strong>I→D→P</strong> (sociological). Dedicated card + PYQ: <button type="button" class="text-link" data-nav="k1001" data-topic="j-def-evolution">Definitions — evolution of jurisprudence</button>.</p>`,
        analogy: {
      ...
      },
      {
        ...
        summary: "The 20-marker is a changelog. Primary rail = full Sem-1 cast in year order (Ulpian to Hart), with school chip and country. Gold B-A-H-G-S-P = compact definitions inset/filter. Footer: A→K→H analytical; I→D→P sociological.",
        ...
        <p>Redraw the left-rail from memory (year · who · where · landmark · said · pushed back · school). Then open Paranjape chapter 1 for the longer extracts — this card does not copy that book.</p>`,
        analogy: {
